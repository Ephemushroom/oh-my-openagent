...
- **`omo-opencode2`** is the OpenCode 2 adapter (v2 plugin API, @opencode-ai/plugin@next). It ports the highest-value v1 surface onto v2's imperative registration API: 11 agents (sisyphus default), 5 base + 3 goal-gated tools, hashline edit + read pairing, the two tool guards, comment checker, rules injection, delegated-task guidance, shared skills, builtin commands, and the default-off goal idle continuation. Port design: [.omo/plans/opencode2-port.md](../.omo/plans/opencode2-port.md); QA regimen: [.agents/skills/opencode2-qa/](../.agents/skills/opencode2-qa/). See [packages/omo-opencode2/AGENTS.md](omo-opencode2/AGENTS.md).
