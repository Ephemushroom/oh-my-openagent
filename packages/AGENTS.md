...
- **omo-opencode2** is the OpenCode 2 adapter (v2 plugin API, @opencode-ai/plugin@next), currently at spike stage: it proves agent registration, tool hooks, session orchestration, synthetic injection, and MCP interop against a real opencode2 binary. Port design: [.omo/plans/opencode2-port.md](../.omo/plans/opencode2-port.md); spike QA evidence: .omo/evidence/20260810-opencode2-spike/. See [packages/omo-opencode2/AGENTS.md](omo-opencode2/AGENTS.md).
